...
void Init()
{
	...
	char * tty_list[] = {"/dev_tty0"};//only use one tty
 ...
 *****************************************************************************/
/**
 * Midori OS's shell written by Liang
 * 
		...
		if (fd == -1) {
			if (rdbuf[0]) {
				...
				else if(strcmp(cmd, "duihua") == 0)
				{
					...
					printf("Unknown command! Enter 'help' to get guidance.");			
				}
			}
		}
		else {
...
PUBLIC void welcome()
{
	...
	printf("              ******************************************************\n");
	printf("              *                                                    *\n");
	printf("              *         Welcome to Midori's Operating System       *\n");
	printf("              *                                                    *\n");
	printf("              ******************************************************\n");
	printf("              *                                                    *\n");
	printf("              *                                                    *\n");
	printf("              *                  Tongji University                 *\n");
	printf("              *            School of Software Engineering          *\n");
	printf("              *                                                    *\n");
	printf("              *                1652700    Liang Chengwei           *\n");
	printf("              *                1652737      Liu Mengqi             *\n");//print the Information of producers
	printf("              *                                                    *\n");
	printf("              *                                                    *\n");
	printf("              ******************************************************\n\n");
}
...
PUBLIC void clear()
{
	int i = 0;
	for (i = 0; i < 5; i++)
		printf("\n");//print enough blank lines to clear the screen
}*/
PUBLIC void clear() {
	int i = 0;
	disp_pos = 0;
...
void help()
{
	...
	printf("        calculator          |           Start a simply calculator\n");
